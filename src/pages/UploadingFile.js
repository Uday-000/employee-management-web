...
export default class UploadingFile extends Component {
  ...
  // handleCancel = () => {
  //   this.props.history.goBack(); // Use this.props.history to navigate
  // };
    ...
    return (
      <div className="uploadDocument">
        <div
          ...
          style={{ border: "1px solid black", height: "50vh", width: "500px" }}
        >
          <h2>File Upload</h2>
          <div className="header" style={{ marginTop: "40px" }}>
            <Button
              ...
              outline
              onClick={() => this.handleUploadType("excel")}
            ...
            <Button
              ...
              onClick={() => this.handleUploadType("xml")}
            >
              Upload XML
            </Button>
          </div>
